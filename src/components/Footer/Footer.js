          ...
          <div className={styles.grid}>
            ...
            <div className={styles.brandCol}>
              <Link href="/" className={styles.logo}>
                <div className={styles.logoIcon}>
                  <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                      <linearGradient id="ftrLg" x1="0" y1="0" x2="42" y2="42" gradientUnits="userSpaceOnUse">
                        <stop stopColor="#7C3AED"/>
                        <stop offset="1" stopColor="#4C1D95"/>
                      </linearGradient>
                    </defs>
                    <rect width="42" height="42" rx="12" fill="url(#ftrLg)"/>
              ...
              <p className={styles.brandDesc}>
                India&apos;s premier online coding academy for Class 6–12 students.
                Empowering young minds with live classes, real projects, and expert mentors.
              </p>

              <div className={styles.contact}>
                <a href="mailto:hello@LumiSkill.com" className={styles.contactItem}>
                  📧 hello@LumiSkill.com
                </a>
              ...
              <div className={styles.socials}>
                <a href="https://instagram.com/LumiSkill" target="_blank" rel="noreferrer" className={styles.social} aria-label="Instagram">
                ...
                <a href="https://youtube.com/@LumiSkill" target="_blank" rel="noreferrer" className={styles.social} aria-label="YouTube">
                ...
                <a href="https://linkedin.com/company/LumiSkill" target="_blank" rel="noreferrer" className={styles.social} aria-label="LinkedIn">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                </a>
                <a href="https://wa.me/919999999999" target="_blank" rel="noreferrer" className={styles.social} aria-label="WhatsApp">
        ...
        <div className="container">
          <div className={styles.bottomInner}>
            <p className={styles.copyright}>
              © {new Date().getFullYear()} LumiSkill. All rights reserved. Made with ❤️ for India&apos;s future coders.
            </p>
